...
; Drive currents
M906 X1200 Y1200 Z1200 E800     ; XYZ and E current
M906 I30                        ; Idle current percentage
M84 S120                        ; Idle timeout

; Endstops
M574 X2 S1 P"^!xstop"           ; X endstop on hall effect board
M574 Y2 S1 P"^!ystop"           ; Y endstop on hall effect board
...
; Z probes
M558 K0 P8 C"^zprobe.in" T18000 F120 H5 A5 S0.01 B0 R0.2
G31 K0 P500 X0 Y25 Z2.425            ; inductive probe offset, needs to be (somewhat) consistent with the other probe otherwise G29 will complain
M558 K1 P8 C"^zstop" T18000 F120 H3 A10 S0.005 B1 R0.2
G31 K1 P500 X0 Y0 Z-0.06             ; Z switch offset (if positive, greater value = lower nozzle. if negative, more negative = higher nozzle)
...
M106 P4 S0.25 H1 T50                ; Run the fans at 25% if the hotend is over 50C
