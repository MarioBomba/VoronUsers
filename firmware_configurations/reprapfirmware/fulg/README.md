...
- It is possible for the gantry to bottom out if it is severely out of level. This is normal. You can solve this by loosening the four Z blocks, leveling the gantry a couple of times until the correction is minimal, then retighten the four Z blocks.
